...
//   const trpc = useTRPC();
//   const { data: users } = useSuspenseQuery(trpc.admin.getUsers.queryOptions());
//   const updateRole = useMutation(trpc.admin.updateUserRole.mutationOptions());
...
//       alert(`${user.name} updated to ${user.role}`);
//     } catch (error) {
//       console.error(error);
//     }
//   };
...
//                     value={user.role}
//                     onValueChange={(value) =>
//                       handleRoleChange(user._id, value as Role)
//                     }>
